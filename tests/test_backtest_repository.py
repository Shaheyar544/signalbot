...
def test_persists_incomplete_run_and_full_trade_audit():
    ...
    repo.save_trade(TradeAudit("trade-1","run-1",run.created_at,"BULLISH",Decimal("100"),Decimal("95"),Decimal("105"),Decimal("110"),Decimal("115"),True,4,None,None,None,None,None,"SAME_CANDLE",True))
